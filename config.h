...
#include <X11/XF86keysym.h> //for volume
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-l", "20", NULL };
...
static const Key keys[] = {
	...
	{ 0,                            XF86XK_AudioLowerVolume, spawn, {.v = downvol } }, //volume
        { 0,                            XF86XK_AudioMute, spawn, {.v = mutevol } },
        { 0,                            XF86XK_AudioRaiseVolume, spawn, {.v = upvol   } },
        { 0,                            XF86XK_MonBrightnessUp, spawn, SHCMD("/usr/bin/brightnessctl s +5%")}, //Brightness
        { 0,                            XF86XK_MonBrightnessDown, spawn, SHCMD("/usr/bin/brightnessctl s 5%-")},
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
